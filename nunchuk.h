...
#define NUNCHUK_JOYSTICK_Y_ZERO 126
...
void nunchuk_print() {
  ...
  void nunchuk_print_JX(){
  Serial.print("X axis: ");
  Serial.print(nunchuk_joystickX(), DEC);

}
  void nunchuk_print_JY(){
  Serial.print("Y axis: ");
  Serial.print(nunchuk_joystickY(), DEC);

}
static void nunchuk_printC(){
  Serial.print("C button: ");
  Serial.print(nunchuk_buttonC(), DEC);

}
static void nunchuk_printZ(){
  Serial.print("Z button: ");
  Serial.print(nunchuk_buttonZ(), DEC);
  
}
static void nunchuk_printAngle(){
  Serial.print("Angle: ");
  Serial.print(nunchuk_joystick_angle());
}
static  double SlidingSpeed(){
  double partial = (nunchuk_joystickX()*nunchuk_joystickX())+(nunchuk_joystickY()*nunchuk_joystickY());
  return  sqrt(partial);
}
static int Angle(){// return angle in deg
        return ((nunchuk_joystick_angle()*180)/3.14);
